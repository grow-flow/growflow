...
import { UpdatePlantType1733668000000 } from './migrations/1733668000000-UpdatePlantType';
...
export const AppDataSource = new DataSource({
  ...
  migrations: [
    InitialSchema1733666000000,
    UpdateStrainType1733667000000,
    UpdatePlantType1733668000000
  ],
  migrationsRun: true,
});
